    ...
    <> 
            ...
            {historico.map((item, i) => (
              ...
              >
                <div className="bg-pink-300 flex flex-col gap-2 p-2 rounded-2xl">
                  ...
                  <img src={iconPerfil} alt="Icone" className="w-4 h-4 mr-2"/> {item.primeiroNome}
                  </div>
                  <div className="flex items-center break-all">
                  <img src={iconPerfil} alt="Icone" className="w-4 h-4 mr-2"/> {item.segundoNome} 
                  </div>
                  <div className="">
      ...
      <div className="bg-pink-50 flex items-center justify-center min-h-screen">
        <div className="flex flex-col items-center text-center gap-10 bg-white p-10 rounded-[20px] min-x-[350px]">
          ...
          {carregando ? (
            <button type="button" class="flex items-center px-4 py-2 bg-pink-400 text-white rounded-[7px]" xmlns="http://www.w3.org/2000/svg" disabled>  
          ...
          {/* Caso resultado seja TRUE vai aparecer -> Null é um tipo false*/}
          {resultado && (
          <div className="flex flex-col gap-4 bg-pink-100 p-6 rounded-[20px] max-w-[300px] border-2 border-pink-200">
            <h1 className="font-bold text-[26px] break-all">{resultado.primeiroNome} ❤️ {resultado.segundoNome}</h1>
